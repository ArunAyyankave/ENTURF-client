      ...
      <div className="container mx-auto">
        {loading ? (
          ...
          <div className="flex flex-col min-h-screen justify-center items-center">
            <p className="sm:text-4xl xl:text-6xl whitespace-nowrap  text-black">No Turfs available at this location</p>
            <button onClick={()=>navigate(-1)} className="bg-blue-600 text-white p-2 rounded mt-3 sm:text-xl xl:text-2xl">Go Back</button>
          </div>
        )}
      </div>
    </div>
